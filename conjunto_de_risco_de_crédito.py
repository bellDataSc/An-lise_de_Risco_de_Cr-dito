  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "# Leia o CSV e execute a limpeza básica de dados"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# Elimine as colunas nulas onde todos os valores são nulos\n",
    "df = df.dropna(axis='columns', how='all')\n",
    "\n",
    "# Descarte as linhas nulas\n",
    "df = df.dropna()\n",
    "\n",
    "# Remova o status do empréstimo `Issued`\n",
    "issued_mask = df['loan_status'] != 'Issued'\n",
    "df = df.loc[issued_mask]\n",
    "\n",
    "# converta a taxa de juros para numérica\n",
    "df['int_rate'] = df['int_rate'].str.replace('%', '')\n",
    "df['int_rate'] = df['int_rate'].astype('float') / 100\n",
    "\n",
    "\n",
    "# Converta os valores da coluna de destino para low_risk e high_risk com base em seus valores\n",
    "x = {'Current': 'low_risk'}   \n",
    "df = df.replace(x)\n",
    "\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Codifique os dados de objetos de string para formas numéricas significativas\n",
    ...
    "}\n",
    "\n",
    "# Altere os meses de emissão e o próximo pagamento para um número correspondente ao mês, em vez do formato de string\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Crie nossos recursos
# Observe que home_ownership, verification_status, issue_date,
X = df_encoded.copy()
...
# Crie nosso alvo\n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "mean   16677.594562      0.127718    480.652863  8.821371e+04      1.726172   \n",
       "std    10277.348590      0.048130    288.062432  1.155800e+05      0.743862   \n",
       "min     1000.000000      0.060000     30.890000  4.000000e+01      1.000000   \n",
       "25%     9000.000000      0.088100    265.730000  5.000000e+04      1.000000   \n",
       "50%    15000.000000      0.118000    404.560000  7.300000e+04      2.000000   \n",
       "75%    24000.000000      0.155700    648.100000  1.040000e+05      2.000000   \n",
       "max    40000.000000      0.308400   1676.230000  8.797500e+06      3.000000   \n",
       "\n",
  ...
  },
  {
   ...
   "source": [
    "# Verifique o equilíbrio dos nossos valores-alvo\n",
  ...
  
  {
   ...
   "metadata": {},
   "source": [
    "### Classificador de Floresta Aleatória Balanceada"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "# Crie o Classificador Balanced Random Forest\n",
  ...
  },
  {
   ...
   "source": [
    "# Calculou a pontuação de precisão balanceada\n",
  ...
  },
  {
   ...
   "source": [
    "# Imprimir o relatório de classificação desbalanceada\n",
  ...
  },
  {
   ...
   "source": [
    "# Liste os recursos classificados em ordem decrescente por importância do recurso\n",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "### Classificador Easy Ensemble AdaBoost"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "# Treine o EasyEnsembleClassifier\n",
